<header id="header" class="fixed-top menu-app">
    ...
    <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
            <li><a class="nav-link scrollto" href="<?php echo base_url().route_to('viviendas') ?>">Viviendas disponibles</a></li>
            <li><a class="nav-link scrollto" href="<?php echo base_url().route_to('publicar') ?>">Publicar</a></li>
            <li><a class="nav-link scrollto" href="<?php echo base_url().route_to('gesusuarios') ?>">Gestionar usuarios</a></li>
            <li><a class="nav-link scrollto" href="<?php echo base_url().route_to('gesviviendas') ?>">Gestionar viviendas</a></li>
